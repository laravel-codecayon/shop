<?php
class AreportsalescategoryController extends BaseController {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'areportsalescategory';
	static $per_page	= '10';
	
	public function __construct() {
		parent::__construct();
		$this->model = new Areportsalescategory();
		...
		$this->data = array(
			...
			'pageModule'	=> 'areportsalescategory',
			'pageUrl'			=> URL::to('areportsalescategory')	
		);
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','areportsalescategory.index',$this->data);
	}	
	...
	{ 
		...
		return View::make('areportsalescategory.table',$this->data);
