<?php
class NordersController extends BaseController {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'norders';
	static $per_page	= '10';
	
	public function __construct() {
		parent::__construct();
		$this->beforeFilter('csrf', array('on'=>'post'));
		$this->model = new Norders();
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','norders.index',$this->data)
	...
	function getAdd( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->layout->nest('content','norders.form',$this->data)->with('menus', $this->menus );	
	}
	...
	function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		$this->layout->nest('content','norders.view',$this->data)->with('menus', $this->menus );	
	}	
	...
	function postSave( $id =0)
	{
		...
		if ($validator->passes()) {
			...
			return Redirect::to('norders?md='.$md)->with('message', SiteHelpers::alert('success',Lang::get('core.note_success')));
		} else {
			return Redirect::to('norders/add/'.$id.'?md='.$md)->with('message', SiteHelpers::alert('error',Lang::get('core.note_error')))
