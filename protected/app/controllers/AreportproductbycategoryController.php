<?php
class AreportproductbycategoryController extends BaseController {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'areportproductbycategory';
	static $per_page	= '10';
	
	public function __construct() {
		parent::__construct();
		$this->model = new Areportproductbycategory();
		...
		$this->data = array(
			...
			'pageModule'	=> 'areportproductbycategory',
			'pageUrl'			=> URL::to('areportproductbycategory')	
		);
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','areportproductbycategory.index',$this->data);
	}	
	...
	{ 
		...
		return View::make('areportproductbycategory.table',$this->data);
