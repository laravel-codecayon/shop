...
class PromotionController extends BaseController {
	...
	public function getIndex()
	{
		...
		$sort = (!is_null(Input::get('sort')) ? Input::get('sort') : 'id_promotion'); 
		...
		$this->layout->nest('content','Promotion.index',$this->data)
	...
	function getAdd( $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('promotion'); 
		}
		...
		$this->data['id'] = $id;
		$this->layout->nest('content','Promotion.form',$this->data)->with('menus', $this->menus );	
	}
	...
	function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		$this->layout->nest('content','Promotion.view',$this->data)->with('menus', $this->menus );	
	}	
	...
	function postSave( $id =0)
	{
		...
		if ($validator->passes()) {
			...
			return Redirect::to('Promotion/add/'.$id.'?md=')->with('message', SiteHelpers::alert('error',Lang::get('core.note_error')))
