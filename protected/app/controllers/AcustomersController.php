<?php
class AcustomersController extends BaseController {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'acustomers';
	static $per_page	= '10';
	
	public function __construct() {
		parent::__construct();
		$this->model = new Acustomers();
		...
		$this->data = array(
			...
			'pageModule'		=> 'acustomers',
			'pageUrl'			=> URL::to('acustomers')		
		);
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','acustomers.index',$this->data);
	}		
	...
	{ 
		...
		return View::make('acustomers.table',$this->data);
	...
	function getAdd( $id = null)
	{
		...
		$this->data['id'] = $id;
		return View::make('acustomers.form',$this->data);
	...
	function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		return View::make('acustomers.view',$this->data);
	...
	function postQuicksave( $id =0)
	{
		...
		$validator = Validator::make(Input::all(), $rules);	
		if ($validator->passes()) {	
			$data = $this->validatePost('CustomerID');
	...
	function postCopy()
	{
		...
		$sql .= " SELECT ".implode(",", $columns)." FROM customers WHERE CustomerID IN (".$toCopy.")";
	//	DB::insert($sql);
		return Response::json(array(
			'status'=>'success',
			'message'=> SiteHelpers::alert('success',Lang::get('core.note_success'))
