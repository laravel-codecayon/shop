<?php
class AreportinvoicesController extends BaseController {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'areportinvoices';
	static $per_page	= '10';
	
	public function __construct() {
		parent::__construct();
		$this->model = new Areportinvoices();
		...
		$this->data = array(
			...
			'pageModule'	=> 'areportinvoices',
			'pageUrl'			=> URL::to('areportinvoices')	
		);
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','areportinvoices.index',$this->data);
	}	
