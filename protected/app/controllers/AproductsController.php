<?php
class AproductsController extends BaseController {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'aproducts';
	static $per_page	= '10';
	
	public function __construct() {
		parent::__construct();
		$this->model = new Aproducts();
		...
		$this->data = array(
			...
			'pageModule'		=> 'aproducts',
			'pageUrl'			=> URL::to('aproducts')		
		);
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','aproducts.index',$this->data);
	}		
	...
	{ 
		...
		return View::make('aproducts.table',$this->data);
	...
	function getAdd( $id = null)
	{
		...
		$this->data['id'] = $id;
		return View::make('aproducts.form',$this->data);
	...
	function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		return View::make('aproducts.view',$this->data);
	...
	function postQuicksave( $id =0)
	{
		...
		$validator = Validator::make(Input::all(), $rules);	
		if ($validator->passes()) {	
			$data = $this->validatePost('ProductID');
